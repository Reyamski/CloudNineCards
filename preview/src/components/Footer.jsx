        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <div className="max-w-xs">
            ...
            <p className="mt-2 text-xs leading-5 text-white/40">
              Sealed TCG drops shipped from Canada. One Piece · Pokémon · Dragon Ball · Yu-Gi-Oh.
            </p>
          ...
          <div className="flex flex-wrap gap-8 text-xs font-black uppercase tracking-[0.16em] text-white/45">
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/singles" className="transition hover:text-fuchsia-300">Singles</Link>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/buylist" className="transition hover:text-yellow-300">Sell Cards</Link>
