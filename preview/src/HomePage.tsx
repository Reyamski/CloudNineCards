          ...
          {[
            {
              ...
              text: 'Every order ships tracked. Canada $24.99 flat (singles, deck packs, sealed). USA $34.99. International $34.99 (Asia, Europe), $44.99 (other). Free shipping in Canada on in-stock orders $300+. Pre-orders pay actual shipping at release.',
            },
            {
              icon: Package,
              title: 'Packed Right',
