  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#05010c] text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-2 pt-6">
        <motion.div initial={{opacity: 0, y: 16}} animate={{opacity: 1, y: 0}} transition={{duration: 0.55}} className="relative overflow-hidden rounded-[32px] border border-fuchsia-400/30">
          <img
          ...
          <div className="relative flex flex-col items-center gap-6 px-8 py-10 text-center sm:flex-row sm:text-left md:px-12">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-fuchsia-400/40 bg-fuchsia-500/20 text-2xl font-black shadow-[0_0_30px_rgba(217,70,239,0.35)]">
              OP
            </div>
            <div className="flex-1">
              ...
              <div className="mt-2 text-2xl font-black uppercase leading-tight md:text-3xl">
                One Piece Card Game <span className="bg-gradient-to-r from-fuchsia-300 via-pink-300 to-yellow-300 bg-clip-text text-transparent">OP-17 Japanese</span>
              </div>
              <p className="mt-1.5 text-sm text-white/55">Watch out - pre-order drops soon. Be first in line.</p>
            </div>
