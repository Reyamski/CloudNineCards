  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#05010c] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-6 md:pb-24 md:pt-8">
          ...
          <div className="grid items-center gap-10 md:grid-cols-[1.04fr_0.96fr] md:gap-12">
            ...
            <motion.div initial={{opacity: 0, scale: 0.96}} animate={{opacity: 1, scale: 1}} transition={{duration: 0.65, delay: 0.1}} className="grid gap-4">
              ...
              {/* YGO CP12 Pre-Order card */}
              <Link
                to="/pre-orders"
                className="relative overflow-hidden rounded-[24px] border border-amber-400/30 bg-[linear-gradient(110deg,#0d0800,#1a0f00)] shadow-xl transition hover:scale-[1.01] hover:border-amber-400/50 flex"
              >
                <img
                  src="/Yu-Gi-Oh! Creation Pack 12.png"
                  alt="Yu-Gi-Oh! Creation Pack 12"
                  className="h-[100px] w-[80px] shrink-0 object-cover saturate-[1.3]"
                />
                ...
                <div className="flex flex-col justify-center px-4 py-3">
                  <div className="flex flex-wrap gap-1.5 mb-1.5">
                    <span className="rounded-full border border-amber-400/40 bg-amber-500/15 px-2 py-0.5 text-[9px] font-black uppercase tracking-[0.2em] text-amber-300">Pre-Order Open</span>
                    <span className="rounded-full border border-red-400/35 bg-red-500/10 px-2 py-0.5 text-[9px] font-black uppercase tracking-[0.2em] text-red-300">Deadline Mar 28</span>
                  </div>
                  <div className="text-sm font-black uppercase leading-tight">Yu-Gi-Oh! Creation Pack 12</div>
                  <div className="mt-0.5 text-[11px] text-white/45">Asian English · Per Case · CAD $1,650.55</div>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-2 pt-6">
        <motion.div initial={{opacity: 0, y: 16}} animate={{opacity: 1, y: 0}} transition={{duration: 0.55}} className="relative overflow-hidden rounded-[32px] border border-amber-400/30">
          <img
            src="/Yu-Gi-Oh! Creation Pack 12.png"
            alt="Yu-Gi-Oh! Creation Pack 12"
            className="absolute inset-0 h-full w-full object-cover opacity-30 saturate-[1.4]"
          />
          <div className="absolute inset-0 bg-[linear-gradient(110deg,rgba(5,1,12,0.97)_0%,rgba(60,30,5,0.82)_50%,rgba(5,1,12,0.93)_100%)]" />
          <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-amber-400 via-yellow-300 to-orange-400" />
          <div className="relative flex flex-col items-center gap-6 px-8 py-10 text-center sm:flex-row sm:text-left md:px-12">
            <div className="h-20 w-20 shrink-0 overflow-hidden rounded-2xl border border-amber-400/40 shadow-[0_0_30px_rgba(251,191,36,0.25)]">
              <img src="/Yu-Gi-Oh! Creation Pack 12.png" alt="" className="h-full w-full object-cover" />
            </div>
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-2">
                <div className="inline-flex items-center gap-2 rounded-full border border-amber-400/40 bg-amber-500/15 px-3 py-1 text-[10px] font-black uppercase tracking-[0.24em] text-amber-300">
                  <BellRing className="h-3 w-3" /> Pre-Order Open
                </div>
                <div className="inline-flex items-center gap-1.5 rounded-full border border-red-400/35 bg-red-500/12 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-red-300">
                  Deadline: Mar 28 · 6PM
                </div>
              </div>
              <div className="mt-2 text-2xl font-black uppercase leading-tight md:text-3xl">
                Yu-Gi-Oh! <span className="bg-gradient-to-r from-amber-300 via-yellow-300 to-orange-300 bg-clip-text text-transparent">Creation Pack 12</span>
              </div>
              <p className="mt-1.5 text-sm text-white/55">Asian English · Per Case (24 Boxes) · CAD $1,650.55 · 30% DP to secure. Limited allocation — pre-orders may be cut.</p>
            </div>
            <div className="shrink-0">
              <Link to="/pre-orders" className="inline-flex items-center gap-2 rounded-full border border-amber-400/50 bg-amber-500/20 px-6 py-2.5 text-xs font-black uppercase tracking-[0.18em] text-amber-200 transition hover:bg-amber-500/30">
